...
* Not adhering to [NeurIPS' LLM use policies](https://neurips.cc/Conferences/2025/LLM)—for instance, if the paper is clearly entirely generated by an LLM.
